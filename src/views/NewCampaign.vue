  ...
  <div>
    <v-form ref="form" v-model="valid" class="settings">
      ...
      <div class="grid">
        <div>
          ...
          <span class="text-overline"
            >Difficulty: {{ labels[selectedDifficulty] }}</span
          >
          <v-slider
        ...
        <div>
          ...
          <span class="text-h6" v-if="selectedCharacterClass === 'primate'"
            >Primate</span
          >
          <span class="text-h6" v-if="selectedCharacterClass === 'berserker'"
            >Berserker</span
          >
          <span class="text-h6" v-if="selectedCharacterClass === 'shaman'"
            >Shaman</span
          >
          <p class="text-body-1" v-if="selectedCharacterClass === 'primate'">
            The primate is the simplest class. It does not give any special
            perks.
          </p>
          <p class="text-body-1" v-if="selectedCharacterClass === 'berserker'">
            The berserker gets better quest rewards, but has less time and
            health.
          </p>
          <p class="text-body-1" v-if="selectedCharacterClass === 'shaman'">
      ...
      <div class="actions">
        ...
        <v-btn
          @click="
            $store.state.campaign == undefined
              ? startCampaign()
              : (existingCampaignDialog = true)
          "
          :disabled="!valid"
          color="primary"
          class="submit-btn"
    ...
    <v-dialog v-model="existingCampaignDialog" persistent max-width="500px">
      <v-card>
        ...
        <v-card-text
          >If you continue, the existing campaign will be overwritten and your
          progress will be reset. Are you sure you would like to
