    ...
    <v-navigation-drawer permanent>
          ...
          <div class="character-information">
            ...
            <div>
              ...
              <div class="name text-caption">
                {{ campaign.balance }} mol SiO<sub>2</sub>
              </div>
            </div>
          </div>
        </v-list-item-content>
      ...
      <v-list-item>
        <v-list-item-content>
          ...
          <div
            v-if="campaign.inventory._items.length == 0"
          ...
          <div class="inventory">
            <div
              v-for="(invItem, index) in campaign.inventory._items"
              :key="index"
              class="item"
            >
              <div v-if="invItem.amount > 1">
                <v-badge color="primary" :content="invItem.amount">
                  <img width="50" height="50" :src="invItem.item.icon" />
                </v-badge>
              </div>
              <img
                width="50"
                height="50"
                v-if="invItem.amount == 1"
      ...
      <v-divider />
      <v-btn class="" @click="campaign.inventory.increment(0)"
        >Add frikandelbroodje</v-btn
      >
...
export default {
  ...
  created() {
    ...
    // Ignore triple equals requirement to match both null and undefined.
